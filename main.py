...
stopuser = {}
token = '8002657632:AAFjytYVv0oi5Zi_V8nUdGmbfhtS3a_z0Qg'
...
┃𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 : <a href='t.me/Moon78692'>⏤͟͟͞͞𝙈𝙊𝙊𝙉 ٭ ᶠᵘᵉᵍᵒ ᯤ̸ 🐦‍🔥</a>
┃━━━━━━━━/━━━━━━━━⍟
...
┃𝟑𝟎 𝐃𝐚𝐲𝐬 𝐑𝐬 𝟏𝟎𝟎𝟎
┃━━━━━━━━/━━━━━━━━⍟
┃𝐁𝐮𝐲 𝐅𝐫𝐨𝐦 <a href='t.me/Moon78692'>⏤͟͟͞͞𝙈𝙊𝙊𝙉 ٭ ᶠᵘᵉᵍᵒ ᯤ̸ 🐦‍🔥</a>
┗━━━━━━━━/━━━━━━━━⍟</b>
''',reply_markup=keyboard)
			return
		with open('data.json', 'r') as file:
...
Bᴏᴛ Bʏ @Moon78692''', reply_markup=mes)
					
					msg=f'''
<a href='https://envs.sh/j4X.jpg'>-</a> 𝐀𝐩𝐩𝐫𝐨𝐯𝐞𝐝 ✅
<a href='t.me/TaitanXBot'>┏━━━━━━━━━━━⍟</a>			
...
<a href='t.me/TaitanXBot'>-</a> 𝐓𝐢𝐦𝐞: <code>1{"{:.1f}".format(execution_time)} 𝐬𝐞𝐜𝐨𝐧𝐝</code> 
<a href='t.me/TaitanXBot'>-</a> 𝐁𝐨𝐭 𝐀𝐛𝐨𝐮𝐭: <a href='t.me/TaitanXBot'>™ 𝐓𝐚𝐢𝐭𝐚𝐧 ~/⚡</a>'''
...
def respond_to_vbv(message):
	def my_function():
		...
		try:
			...
			msg=f'''<b>Tᴀɪᴛᴀɴ Mᴀss Cʜᴇᴄᴋᴇʀ Sᴜsᴄʀɪᴘᴛɪᴏɴs Exᴘɪʀᴇ Iɴ ➜ {timer}
𝗧𝗬𝗣 ➜ {typ}</b>'''
...
print("𝐓𝐚𝐢𝐭𝐚𝐧'𝐒 𝐌𝐚𝐬𝐬 𝐂𝐡𝐞𝐜𝐤𝐞𝐫 𝐁𝐨𝐭 𝐰𝐚𝐬 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐒𝐭𝐚𝐫𝐭𝐞𝐝 🫧")
while True:
	try:
		bot.polling(none_stop=True)
	except Exception as e:
		print(f"𝐓𝐚𝐢𝐭𝐚𝐧'𝐒 𝐌𝐚𝐬𝐬 𝐂𝐡𝐞𝐜𝐤𝐞𝐫 𝐁𝐨𝐭 𝐰𝐚𝐬 ❌{e}")